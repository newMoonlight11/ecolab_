...
@section('form_content')
    <div class="form-group mb-2 mb20">
        ...
        <input type="date" name="fecha_movimiento"
            class="form-control bg-white rounded-4 @error('fecha_movimiento') is-invalid @enderror"
    ...
    <div class="form-group mb-2 mb20">
        ...
        <input type="text" name="descripcion"
            class="form-control bg-white rounded-4 @error('descripcion') is-invalid @enderror"
    ...
    <div class="form-group mb-2 mb20">
        ...
        <input type="text" name="usuario_id"
            class="form-control bg-white rounded-4 @error('usuario_id') is-invalid @enderror"
