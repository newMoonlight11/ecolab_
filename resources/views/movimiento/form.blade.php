<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_movimiento" class="form-control @error('fecha_movimiento') is-invalid @enderror" value="{{ old('fecha_movimiento', $movimiento?->fecha_movimiento) }}" id="fecha_movimiento" placeholder="Fecha Movimiento">
