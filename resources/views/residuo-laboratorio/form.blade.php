...
@section('form_content')
    <div class="form-group mb-2 mb20">
        ...
        <input type="date" name="fecha_stock" class="form-control @error('fecha_stock') is-invalid @enderror"
            value="{{ old('fecha_stock', $residuoLaboratorio?->fecha_stock) }}" id="fecha_stock" placeholder="Fecha Stock">
    ...
    <div class="form-group mb-2 mb20">
        ...
        <select name="residuo_id" id="residuo_id" class="form-control @error('residuo_id') is-invalid @enderror">
